...
export const chatRequests = new Counter({
  name: 'codelance_chat_requests_total',
...
export const cacheHits = new Counter({
  name: 'codelance_cache_hits_total',
  help: 'Total number of Redis cache hits',
  registers: [register]
});

export const ragDuration = new Histogram({
  name: 'codelance_rag_duration_seconds',
...
export const ingestionDuration = new Histogram({
  name: 'codelance_ingestion_duration_seconds',
...
export const embeddingRequests = new Counter({
  name: 'codelance_embedding_requests_total',
